            ...
            <div class="col-lg-offset-3 col-lg-6">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title">Aja ToDo List <a href="#" id="addNew" class="pull-right" data-toggle="modal" data-target="#myModal"><i class="fa fa-plus" aria-hidden="true"></i></a></h3>
                    </div>
    ...
    <script>
        $(document).ready(function () {
            ...
            $('#delete').click(function(event) {
                var id = $('#id').val();
                // $.post('path', {param1: 'value1'}, function(data, textStatus, Xhr) { });
